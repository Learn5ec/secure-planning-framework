...
2. **Strict Onboarding and Approval Workflow**: Adding or updating any tool description or functionality requires:
   - Code scanning (SAST)
   - Dynamic testing
...
4. **Tool Structure Validation**: Maintain and audit all fields of each tool. Only expose the **minimal, strictly necessary fields** to the model. Keep internal metadata and sensitive fields outside model context.
