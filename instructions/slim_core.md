...
> If the application is high-risk (financial, multi-agent, healthcare), you MUST ALSO read `instructions/common_considerations.md` for the full set of extended baseline controls.
